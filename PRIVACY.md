...
Google Wallet support stores only the last four card digits and the local card name supplied by the user. Full card numbers are never requested or stored. Wallet notifications from cards without a local mapping are ignored.
